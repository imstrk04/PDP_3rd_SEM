...
# List comprehension to create a unique list of faculty
unique_faculty_list = list({person.name for person in people_at_college if person.role.lower() == 'faculty'})

# Set comprehension to create a set of faculty in different departments
faculty_in_departments = {person.name: person.department for person in people_at_college if person.role.lower() == 'faculty'}

# Print the results
print("Unique List of Faculty:", unique_faculty_list)
print("Faculty in Different Departments:", faculty_in_departments)
