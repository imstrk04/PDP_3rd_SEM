...
class WelcomePage:
    def __init__(self, root):
        ...
        Label(root, text = "WELCOME TO BOOK IT",font=('Arial', 50, 'bold'), fg="#1089ff", bg="#d7dae2").pack(pady = 50)
        Button(root, text="Register", command=self.open_register_page, height=3, width=15).pack(pady=100)
        Button(root, text="Login", command=self.open_login_page, height=3, width=15).pack(pady=20)
...
class RegisterPage:
    def __init__(self, root):
        ...
        Label(root, text="REGISTRATION PAGE", font=('Arial', 50, 'bold'), fg="#ed3833", bg="#d7dae2").pack(pady=20)
        ...
        Entry(root, textvariable=self.password, show="*", font=("Arial", 20)).pack()

        Button(root, text="Register", command=self.register, height=2, width=10, font=("Arial", 15)).pack(pady=10)
        Button(root, text="Back", command=self.go_back, height=2, width=10, font=("Arial", 15)).pack(pady=10)
        Button(root, text="Reset", command=self.reset, height=2, width=10, font=("Arial", 15)).pack(pady=10)
...
class LoginPage:
    def __init__(self, root):
        ...
        Label(root, text="LOGIN PAGE", font=('Arial', 50, 'bold'), fg="#ed3833", bg="#d7dae2").pack(pady=20)
        ...
        Button(root, text="Login", command=self.login, height=2, width=10, font=("Arial", 15)).pack(pady=10)
        Button(root, text="Back", command=self.go_back, height=2, width=10, font=("Arial", 15)).pack(pady=10)
